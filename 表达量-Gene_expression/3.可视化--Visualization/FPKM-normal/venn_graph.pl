#!/data/software/perl/perl-v5.24.1/bin/perl
...
###################### software or env ###############################################################
my $env="export PATH=/data/software/gcc/gcc-v6.4.0//bin/:/data/software/Anaconda3/envs/mro-v3.4.3/bin/:/data/software/ImageMagick/ImageMagick-v7.0.8-14/bin/:\$PATH";
...
sub Petals{
	...
	print SVGFILE $out;
	close SVGFILE;
	system("$env && convert $prefix\.svg -quality 92 $prefix\.png");
}
