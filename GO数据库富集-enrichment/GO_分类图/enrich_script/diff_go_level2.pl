...
system("/home/lipeng/miniconda3/bin/Rscript $Bin/GO.level2.r --bpGOterm $outdir/BP.go2gene.$mark.txt --mfGOterm $outdir/MF.go2gene.$mark.txt --ccGOterm $outdir/CC.go2gene.$mark.txt --level2 $Bin/endNode3.csv");
...
close STAT;
close TMP;
system("/home/lipeng/miniconda3/bin/Rscript $Bin/GOClassificationMap.r --infile $outdir/GO.level2.stat.$mark.xls_tmp --outpath $outdir --fileName GO.level2.stat.$mark --mark $groupname ");#&& rm $outdir/GO.level2.stat.$mark.xls_tmp
