...
#############################画总图##############################
figure <- plot_grid(p1,p2,p3, labels = c("BP", "CC", "MF"), ncol = 3, nrow = 1)

ggsave(paste0(opt$outpath, "/GO(MFBPCC).top.", "pdf"), height=10, width=18, plot=figure)
ggsave(paste0(opt$outpath, "/GO(MFBPCC).top.", "png"), type="cairo-png", height=10, width=18, plot=figure)
