...
pie(x=family$Number,labels=paste0(data$Species,"(",as.numeric(data$Number),",",ratio,")",sep=""),col=rainbow(length(family$Species)),cex.lab=20,main=paste0(groupname,":","DEGs classification on Top10 TFs family"))
dev.off()
